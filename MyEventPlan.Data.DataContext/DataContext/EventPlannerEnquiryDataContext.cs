...
{
    public class EventPlannerEnquiryDataContext : DbContext
    {
        ...
        public EventPlannerEnquiryDataContext()
            : base("name=Event")
        {
        }
        ...
        public System.Data.Entity.DbSet<Event.Data.Objects.Entities.EventPlannerEnquiry> EventPlannerEnquiries { get; set; }
    }
}
