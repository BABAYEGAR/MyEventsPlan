...
test("from",
    function(assert) {
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 112 }), true),
            "wa’vatlh wa’maH cha’ DIS",
            "112 years = 112 years");
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 122 }), true),
            "wa’vatlh cha’maH cha’ DIS",
            "122 years = 122 years");
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 213 }), true),
            "cha’vatlh wa’maH wej DIS",
            "213 years = 213 years");
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 223 }), true),
