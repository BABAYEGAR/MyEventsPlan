...
test("from",
    function(assert) {
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ s: 44 }), false),
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ s: 90 }), false),
            "pirms 2 minūtēm",
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ h: 36 }), false),
            "pirms 2 dienām",
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ d: 46 }), false),
            "pirms 2 mēnešiem",
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ d: 76 }), false),
            "pirms 3 mēnešiem",
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 5 }), false),
            "pirms 5 gadiem",
        ...
        assert.equal(start.from(moment([2007, 1, 28]).add({ y: 221 }), false),
            "pirms 221 gada",
