...
test("parse",
    function(assert) {
        ...
        function equalTest(input, mmm, i) {
            assert.equal(moment(input, mmm).month(),
                i,
                input + " should be month " + (i + 1) + " instead is month " + moment(input, mmm).month());
        }
...
test("weeks year starting wednesday custom",
    function(assert) {
        assert.equal(moment("2003 1 6", "gggg w d").format("YYYY-MM-DD"),
            "٢٠٠٢-١٢-٢٨",
            "Week 1 of 2003 should be Dec 28 2002");
        assert.equal(moment("2003 1 0", "gggg w e").format("YYYY-MM-DD"),
            "٢٠٠٢-١٢-٢٨",
            "Week 1 of 2003 should be Dec 28 2002");
        assert.equal(moment("2003 1 6", "gggg w d").format("gggg w d"),
            "٢٠٠٣ ١ ٦",
            "Saturday of week 1 of 2003 parsed should be formatted as 2003 1 6");
        assert.equal(moment("2003 1 0", "gggg w e").format("gggg w e"),
            "٢٠٠٣ ١ ٠",
