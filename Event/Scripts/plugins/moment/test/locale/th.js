...
test("parse",
    function(assert) {
        var tests =
                "มกราคม ม.ค._กุมภาพันธ์ ก.พ._มีนาคม มี.ค._เมษายน เม.ย._พฤษภาคม พ.ค._มิถุนายน มิ.ย._กรกฎาคม ก.ค._สิงหาคม ส.ค._กันยายน ก.ย._ตุลาคม ต.ค._พฤศจิกายน พ.ย._ธันวาคม ธ.ค."
                    .split("_"),
            i;
...
test("calendar day",
    function(assert) {
        ...
        assert.equal(moment(a).subtract({ d: 1 }).calendar(),
            "เมื่อวานนี้ เวลา 12 นาฬิกา 0 นาที",
