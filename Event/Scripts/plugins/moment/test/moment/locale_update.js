...
test("calendar",
    function(assert) {
        ...
        assert.equal(anchor.clone().subtract(1, "day").calendar(anchor),
            "Yesterday at 12:00",
            "yesterday uses parent version");
        assert.equal(anchor.clone().subtract(3, "days").calendar(anchor),
            "Last week at 12:00",
...
test("missing",
    function(assert) {
        ...
        assert.equal(anchor.clone().add(3, "days").calendar(anchor),
            "Next week at 12:00",
