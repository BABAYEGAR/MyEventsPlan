...
// resolve TaskQueue::push's promise, for the caller. will receive result of taskFunc.
        ...
        this.add = // potentially debounce, for the public method
            typeof debounceWait === "number" ? debounce(addTask, debounceWait) : addTask;
        ...
        MouseIgnorerMixin,
        {
            ...
            bindHandlers: function() {
                ...
                if (this.isTouch) {
                    ...
                    if (
                        !bindAnyScroll(this
                                .handleTouchScrollProxy) && // hopefully this works and short-circuits the rest
            ...
            var dragListener = _this.externalDragListener = new HitDragListener(this,
                {
                    ...
                    hitOver: function(hit) {
                        dropLocation = _this.computeExternalDrop(
                            hit.component
                            .getHitSpan(hit), // since we are querying the parent view, might not belong to this grid
                            meta
                        );

                        if (// invalid hit?
                            dropLocation &&
                                !calendar.isExternalSpanAllowed(_this.eventToSpan(dropLocation),
                                    dropLocation,
                                    meta.eventProps)
                        ) {
                            disableCursor();
    ...
    var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin,
        {
            ...
            renderHelper: function(event, sourceSeg) {
                ...
                segs =
                    this.renderFgSegEls(segs); // assigns each seg's el and returns a subset of segs that were rendered
                ...
                .on("click",
                    function(ev) {
                        ...
                        if (typeof clickOption === "function") {
                            ...
                            clickOption = view.publiclyTrigger("eventLimitClick",
                                null,
                                {
                                    date: date,
                                    dayEl: dayEl,
    ...
    var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin,
        {
            ...
            computeTimeTop: function(time) {
                ...
                var slatCoverage =
                    (time - this.minTime) / this.slotDuration; // floating-point value of # of slots covered
                var slatIndex;
                var slatRemainder;
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    var View = FC.View = Class.extend(EmitterMixin,
        ListenerMixin,
        {
            ...
            executeDateRender: function(date) {
                ...
                return this.executeDateUnrender()
                    .then(function() {
            ...
            bindEvents: function() {
                ...
                if (!this.isEventsBound) {
                    ...
                    this.rejectOn("eventsUnbind", this.requestEvents())
                        .then(function(events) { // TODO: test rejection
            ...
            executeEventsRender: function(events) {
                ...
                return this.executeEventsUnrender()
                    .then(function() {
        ...
        t.bindOptions([
            ...
            function(locale, monthNames, monthNamesShort, dayNames, dayNamesShort, firstDay, weekNumberCalculation) {
                ...
                if (// whitelist certain kinds of input
                    ...
                    localeData
                        ._fullCalendar_weekCalc = weekNumberCalculation; // moment-ext will know what to do with it
                }
    ...
    function EventManager() { // assumed to be a calendar
        ...
        function isFetchNeeded(start, end) {
            return !rangeStart || // nothing has been fetched yet?
                start < rangeStart ||
                end > rangeEnd; // is part of the new range outside of the old range?
        }
