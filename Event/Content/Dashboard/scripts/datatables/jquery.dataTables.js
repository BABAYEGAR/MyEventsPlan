            ...
            */
            ...
            function _fnBuildAjax(oSettings, data, fn) {
                ...
                if ($.isPlainObject(oSettings.ajax) && oSettings.ajax.data) {
                    ...
                    var newData = $.isFunction(ajaxData)
                        ? ajaxData(data)
                        : // fn can manipulate data or return an object or array
            ...
            function _fnAjaxParameters(oSettings) {
                ...
                param("iDisplayLength",
                    oSettings.oFeatures.bPaginate !== false ? oSettings._iDisplayLength : -1
                );
            ...
            function _fnInfoMacros(oSettings, str) {
                ...
                return str.replace(/_START_/g, sStart)
            ...
            function _fnFeatureHtmlLength(oSettings) {
                ...
                nLength
                    .innerHTML = "<label>" + oSettings.oLanguage.sLengthMenu.replace("_MENU_", sStdMenu) + "</label>";
            ...
            function _fnFeatureHtmlPaginate(oSettings) {
                ...
                DataTable.ext.oPagination[oSettings.sPaginationType].fnInit(oSettings,
                    nPaginate,
                    function(oSettings) {
                        _fnCalculateEnd(oSettings);
                        _fnDraw(oSettings);
            ...
            function _fnFeatureHtmlTable(oSettings) {
                ...
                nScrollHeadInner.style.width = oSettings.oScroll
                    .sXInner !==
                    ""
                                ...
                                for (var i = 0; i < oSettings.aaSorting.length; i++) {
                                    if (oSettings.aaSorting[i][0] == iDataIndex) {
                                        ...
                                        if (!oSettings.aoColumns[iColumn].asSorting[iNextSort]) {
                                            ...
                                            oSettings
                                                .aaSorting[i][1] = oSettings.aoColumns[iColumn].asSorting[iNextSort];
            ...
            DataTable = function(oInit) {
                ...
                this.fnDestroy = function(bRemove) {
                    ...
                    if (iLen) {
                        ...
                        for (i = 0; i < iLen; i++) {
                            anRows.filter(":nth-child(" + iLen + "n + " + i + ")")
                ...
                this.fnSortListener = function(nNode, iColumn, fnCallback) {
                    _fnSortAttachListener(_fnSettingsFromNode(this[DataTable.ext.iApiIndex]),
                        nNode,
                        iColumn,
                        fnCallback);
                };
