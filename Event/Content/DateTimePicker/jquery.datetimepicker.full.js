...
(function(factory) {
    ...
    var default_options = {
        i18n: {
            ...
            da: { // Dansk
                months: [
                    "January", "Februar", "Marts", "April", "Maj", "Juni", "July", "August", "September", "Oktober",
                    "November", "December"
                ],
                dayOfWeekShort: [
            ...
            lt: { //Lithuanian (lietuvių)
                months: [
                    "Sausio", "Vasario", "Kovo", "Balandžio", "Gegužės", "Birželio", "Liepos", "Rugpjūčio", "Rugsėjo",
            ...
            kg: { // Kyrgyz
                months: [
                    "Үчтүн айы", "Бирдин айы", "Жалган Куран", "Чын Куран", "Бугу", "Кулжа", "Теке", "Баш Оона",
                    "Аяк Оона", "Тогуздун айы", "Жетинин айы", "Бештин айы"
                ],
                dayOfWeekShort: [
    ...
    $.fn.xdsoftScroller = function(percent) {
        return this.each(function() {
            ...
            if (!$(this).hasClass("xdsoft_scroller_box")) {
                ...
                scroller
                    .on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller",
                        function(event) {
                            if (!parentHeight) {
                ...
                timeboxparent.on("touchstart",
                    function(event) {
                        start = pointerEventToXY(event);
                        startTop = Math.abs(parseInt(timebox.css("marginTop"), 10));
                    });

                timeboxparent.on("touchmove",
                    function(event) {
                        if (start) {
                            event.preventDefault();
    ...
    $.fn.datetimepicker = function(opt, opt2) {
        var result = this,
            ...
            lazyInit = function(input) {
                input
                    .on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart",
        ...
        createDateTimePicker = function(input) {
            ...
            month_picker
                ...
                .on("touchstart mousedown.xdsoft",
                    function(event) {
                        ...
                        if (_xdsoft_datetime.currentTime) {
                            val = _xdsoft_datetime
                                .currentTime[$(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]();
                        }
                ...
                .on("touchstart mousedown.xdsoft",
                    ...
                    function() {
                        ...
                        if (_xdsoft_datetime && _xdsoft_datetime.currentTime) {
                            _xdsoft_datetime.currentTime[$(this).parent().parent().hasClass("xdsoft_monthselect")
                                ? "setMonth"
                                : "setFullYear"]($(this).data("value"));
                        }
            ...
            datetimepicker.setOptions = function(_options) {
                ...
                if (_options.highlightedDates &&
                    $.isArray(_options.highlightedDates) &&
                    _options.highlightedDates.length) {
                    $.each(_options.highlightedDates,
                        function(index, value) {
                            var splitData = $.map(value.split(","), $.trim),
                                exDesc,
                                hDate = new HighlightedDate(dateHelper.parseDate(splitData[0], options.formatDate),
                                    splitData[1],
                                    splitData[2]), // date, desc, style
                ...
                if (options.minDate && /^[\+\-](.*)$/.test(options.minDate)) {
                    options.minDate = dateHelper.formatDate(_xdsoft_datetime.strToDateTime(options.minDate),
                        options.formatDate);
                }

                if (options.maxDate && /^[\+\-](.*)$/.test(options.maxDate)) {
                    options.maxDate = dateHelper.formatDate(_xdsoft_datetime.strToDateTime(options.maxDate),
                        options.formatDate);
                }
...
// parseDate() may skip some invalid parts like date or time, so make it clear for user: show parsed date/time
                                        ...
                                        if (!options.datepicker &&
                                            ...
                                            splittedMinutes < 60) {
                                            $(this)
                                                .val([splittedHours, splittedMinutes].map(function(item) {
            ...
            datetimepicker.on("afterOpen.xdsoft",
                function() {
                    timeboxparent.xdsoftScroller();
                });
            ...
            XDSoft_datetime = function() {
                ...
                _this.strToDateTime = function(sDateTime) {
                    ...
                    if (tmpDate && tmpDate[2]) {
                        ...
                        currentTime = new Date((_this.now(true))
                            .getTime() +
                ...
                .on("xchange.xdsoft",
                    function(event) {
                        ...
                        xchangeTimer = setTimeout(function() {
                                ...
                                while (i < _xdsoft_datetime.currentTime.countDaysInMonth() ||
                                    ...
                                    if (options.allowDateRe &&
                                        Object.prototype.toString.call(options.allowDateRe) === "[object RegExp]") {
                                        if (!options.allowDateRe
                                            .test(dateHelper.formatDate(start, options.formatDate))) {
                                            classes.push("xdsoft_disabled");
                                        }
                                    } else if (options.allowDates && options.allowDates.length > 0) {
                                        if (options.allowDates
                                            .indexOf(dateHelper.formatDate(start, options.formatDate)) ===
                                            -1) {
                                            classes.push("xdsoft_disabled");
                                        }
                                    } else if ((maxDate !== false && start > maxDate) ||
                                        (minDate !== false && start < minDate) ||
                                        (customDateSettings && customDateSettings[0] === false)) {
                                        classes.push("xdsoft_disabled");
                                    } else if (options.disabledDates
                                        .indexOf(dateHelper.formatDate(start, options.formatDate)) !==
                                        -1) {
                                        classes.push("xdsoft_disabled");
                                    ...
                                    if ((options.defaultSelect || datetimepicker.data("changed")) &&
                                        dateHelper.formatDate(_xdsoft_datetime.currentTime, options.formatDate) ===
                                        dateHelper.formatDate(start, options.formatDate)) {
                                        classes.push("xdsoft_current");
                                    }

                                    if (dateHelper.formatDate(today, options.formatDate) ===
                                        dateHelper.formatDate(start, options.formatDate)) {
                                    ...
                                    if (start.getDay() === 0 ||
                                        start.getDay() === 6 ||
                                        options.weekends.indexOf(dateHelper.formatDate(start, options.formatDate)) !==
                                        -1) {
                                        classes.push("xdsoft_weekend");
                                    }

                                    if (options.highlightedDates[dateHelper.formatDate(start, options.formatDate)] !==
                                        undefined) {
                                        hDate = options.highlightedDates[dateHelper
                                            .formatDate(start, options.formatDate)];
                                        classes.push(hDate
                                            .style ===
                                            undefined
                                ...
                                month_picker.find(".xdsoft_label span")
                                    .eq(0)
                                    .text(options.i18n[globalLocale].months[_xdsoft_datetime.currentTime.getMonth()]);
                                month_picker.find(".xdsoft_label span")
                                    .eq(1)
                                ...
                                line_time = function line_time(h, m) {
                                    var now = _xdsoft_datetime.now(),
                                        optionDateTime,
                                        current_time,
                                        isALlowTimesInit = options.allowTimes &&
                                    ...
                                    classes = [];
                                    if ((options.minDateTime !== false && options.minDateTime > optionDateTime) ||
                                        (options.maxTime !== false &&
                                            _xdsoft_datetime.strtotime(options.maxTime).getTime() < now.getTime()) ||
                                        (options.minTime !== false &&
                                            _xdsoft_datetime.strtotime(options.minTime).getTime() > now.getTime())) {
                                        classes.push("xdsoft_disabled");
                                    } else if ((options
                                            .minDateTime !==
                                            false &&
                                        ...
                                        ((options.disabledMinTime !== false &&
                                                now.getTime() >
                                                _xdsoft_datetime.strtotime(options.disabledMinTime).getTime()) &&
                                            (options.disabledMaxTime !== false &&
                                                now.getTime() <
                                                _xdsoft_datetime.strtotime(options.disabledMaxTime).getTime()))) {
                                        classes.push("xdsoft_disabled");
                                    } else if (input.is("[readonly]")) {
                                        classes.push("xdsoft_disabled");
                                    }
                                    ...
                                    if (parseInt(today.getHours(), 10) === parseInt(h, 10) &&
                                ...
                                for (i = parseInt(options.monthStart, 10), opt = "";
                    ...
                    function(event) {
                        ...
                        if (!options.datepicker && options.timepicker) {
                            current_time_index = timebox.find(".xdsoft_current").length
                                ...
                                : 0;
                            if (current_time_index + event.deltaY >= 0 &&
            ...
            setPos = function() {
                ...
                forEachAncestorOf(datetimepickerElem,
                    function(ancestorNode) {
                                    ...
                                    .on("touchstart mousedown.xdsoft",
                                        function arguments_callee6() {
                                            ...
                                            $([
                                                ...
                                                .off("touchstart mousedown.xdsoft", arguments_callee6);
                                        });
                            }
                        }
                    })
            ...
            function setMask(options) {
                ...
                var isValidValue = function(mask, value) {
                    ...
                    setCaretPos = function(node, pos) {
                        node = (typeof node === "string" || node instanceof String)
                    ...
                    input.on("keydown.xdsoft",
                        function(event) {
                            ...
                            if (((key >= KEY0 && key <= KEY9) || (key >= _KEY0 && key <= _KEY9)) ||
                                ...
                                while (/[^0-9_]/.test(options.mask.substr(pos, 1)) &&
                                ...
                                if (([AKEY, CKEY, VKEY, ZKEY, YKEY].indexOf(key) !== -1 && ctrlDown) ||
                                    [ESC, ARROWUP, ARROWDOWN, ARROWLEFT, ARROWRIGHT, F5, CTRLKEY, TAB, ENTER]
                                    .indexOf(key) !==
                                    -1) {
                                    return true;
                                }
                ...
                .on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart",
                    function() {
                        if (input.is(":disabled") ||
                            (input.data("xdsoft_datetimepicker").is(":visible") && options.closeOnInputClick)) {
                            return;
                        }
                        clearTimeout(timer);
