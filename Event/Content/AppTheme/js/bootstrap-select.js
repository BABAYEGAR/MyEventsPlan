(function($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function() {
            ...
            this.$newElement.on("hide.bs.dropdown",
                function(e) {
                    that.$element.trigger("hide.bs.select", e);
                });

            this.$newElement.on("hidden.bs.dropdown",
                function(e) {
            ...
            this.$newElement.on("shown.bs.dropdown",
                function(e) {
            ...
            this.$element.find("option").each(function(index) {
                ...
                var optionClass = this.className || "",
                    ...
                    isDisabled = this.disabled ||
                        this.parentElement.tagName === "OPTGROUP" && this.parentElement.disabled;
            ...
            if (updateLi !== false) {
                this.$element.find("option").each(function(index) {
                    ...
                    that.setDisabled(index,
                        this.disabled || this.parentElement.tagName === "OPTGROUP" && this.parentElement.disabled,
                        $lis);
        ...
        setSize: function() {
            ...
            if (this.options.size === "auto") {
                ...
                var optIndex = this.$lis.not(".divider").not(notDisabled).children().slice(0, this.options.size).last()
                        .parent().index(),
        ...
        selectPosition: function() {
            var that = this,
                ...
                getPlacement = function($element) {
                    $drop.addClass($element.attr("class").replace(/form-control|fit-width/gi, ""))
                ...
                function() {
                    if (that.$searchbox.val()) {
                        ...
                        if (that.options.liveSearchNormalize) {
                            ...
                            $searchBase =
                                $searchBase.not(":" + that._searchStyle() + "(" + that.$searchbox.val() + ")");
                        }
