    ...
    e.fn.prettyPhoto = function(s) {
        function g() {
            ...
            $pp_pic_holder.find(".pp_content")
                .animate({ height: a["contentHeight"], width: a["contentWidth"] }, settings.animation_speed);
        ...
        function k(t) {
            if (settings.social_tools)
                facebook_like_link = settings.social_tools
